...
Status: foundation established; application behavior is planned and unverified. This charter defines the intended v0.1 scope and acceptance criteria, not capabilities that exist today.
